...
export default function AddressMap() {
    ...
    return (
        <div className="relative h-full w-full text-white overflow-hidden
            ...
            <div className="absolute left-0 top-[54px] w-full h-14 z-10">
                ...
                >
                    <svg width="30" height="30" viewBox="0 0 24 24" fill="none">
                        <path d="M15 6L9 12l6 6" stroke="white" strokeWidth="2" strokeLinecap="round"
            ...
            {/* 지도 영역 (플레이스홀더) */}
            <img
                className="absolute left-0 top-[120px] w-[402px] h-[752px] object-cover"
                src="/images/signup/map.png"
                alt=""
            />

            {/* 말풍선 */}
            <div className="absolute left-[88px] top-[350px] bg-black text-white text-[12px] px-3 py-2 rounded">
                바꾼 위치가 주소와 같은지 확인해주세요
            </div>

            {/* 위치 핀 모양 대충 */}
            <img
                className="absolute left-45 top-96 w-[40px] h-[40px] object-cover"
                src="/images/signup/MapPin.png"
                alt=""
            />
            ...
            <div className="absolute left-0 bottom-0 w-full py-6 bg-gradient-to-bl from-gray-900 via-black to-neutral-900
                ...
                <div className="mx-4 h-10 px-4 bg-red-200/70 rounded-lg grid place-items-center">
                    <div className="text-black text-[12px] font-light">
